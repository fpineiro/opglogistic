...
<?php echo $this->Form->create('Bodega'); ?>
	...
	<?php
		echo $this->Form->input('ID', array('label' => '<h5>Jefe de Bodega</h5>', 'options' => $jb));
		echo $this->Form->input('CLIENTE_ID', array('label' => '<h5>Cliente asociado</h5>', 'options' => $clientes));
