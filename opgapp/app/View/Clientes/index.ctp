...
<div class="clientes index">
	...
	echo '<legend><h3>Lista de clientes</h3></legend>';
	...
	echo $this->Html->link('Ingresar cliente', array('action' => 'add'), array('class' => 'btn btn-success', 'style'=>'float:right'));	
	echo '<h5>'."Seleccione un cliente para ver su detalle".'</h5><br>';
	?>
	<!--<div class="actions">
	<ul>
