...
class AppController extends Controller {
    ...
    public function estaAutorizado($rol, $controller, $action){
        $adminAutorizado = array(
            ...
            'clientes' => array('index', 'add', 'find'),
            'bodegas' => array('index', 'add', 'edit', 'view', 'delete'),
            'proveedors' => array('index', 'add', 'edit', 'view', 'find'),
            'solicitudembalajes' => array('index', 'view'),
            'ordencompras' => array('index', 'view'),
            'ordendespachos' => array('index', 'view', 'add'),
            'compatibilidads' => array('index', 'add', 'find'),

        );
        $jbAutorizado = array(
            'users' => array('unauthorized', 'login', 'logout', 'find'),
            'clientes' => array('index', 'add'),
            'materialindividuals' => array('index', 'find', 'add'),
            'cajamaterialindividuals' => array('add'),
            'materialdeembalajes' => array('index', 'add'),
            'cajamaterialdeembalajes' => array('add'),
