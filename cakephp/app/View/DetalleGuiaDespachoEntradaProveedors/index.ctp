<div class="detalleGuiaDespachoEntradaProveedors index">
	...
	<tr>
		...
		<td><?php echo h($detalleGuiaDespachoEntradaProveedor['DetalleGuiaDespachoEntradaProveedor']['MATERIAL_DE_EMBALAJE_ID']); ?>&nbsp;</td>
		<td><?php echo h($detalleGuiaDespachoEntradaProveedor['DetalleGuiaDespachoEntradaProveedor']['CAJA_MATERIAL_DE_EMBALAJE_ID']); ?>&nbsp;</td>
