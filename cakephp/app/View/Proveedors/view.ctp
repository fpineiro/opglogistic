...
<fieldset>
	...
	<div style="float:right"><?php echo $this->Form->postLink(('Eliminar proveedor'), array('action' => 'delete', $proveedor['Proveedor']['PROVEEDOR_ID'], null, ('Está que desea seguro de eliminar proveedor# %s?'), $proveedor['Proveedor']['PROVEEDOR_ID']), array('class' => 'btn btn-danger')); ?></div>
	<div style="float:right"><?php echo $this->Html->link(__('Editar proveedor'), array('action' => 'edit', $proveedor['Proveedor']['PROVEEDOR_ID']), array('class' => 'btn btn-primary')); ?>&nbsp;</div>
